...
python /projects/arpae/terraref/shared/extractors/extractors-hyperspectral/hyperspectral/hyperspectral_scratch.py --input="/scratch/vnir_netcdf/vnir_pt2.txt"